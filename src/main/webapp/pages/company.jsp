                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="#" class="btn btn-primary btn-xs" data-toggle="modal"
                                           data-target="#customerEditDialog" onclick="editCompany(${row.com_id})">
                                            修改
                                        </a>
                                        <a href="#" class="btn btn-danger btn-xs"
                                           onclick="deleteCompany(${row.com_id})">
                                            删除
                                        </a>
                                        <a href="#" class="btn btn-primary btn-xs" data-toggle="modal"
                                           data-target="#cvDialog" onclick="showAllCV(${row.com_id})">
                                            简历信息
                                        </a>
                                    </td>
                                </tr>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">新建招聘信息</h4>
            </div>
            <div class="modal-body">
                <form class="form-horizontal" id="new_company_form">
                    <input type="hidden" id="en_id" name="en_id" value="${en_id}"/>
                    <div class="form-group">
                        <label for="new_companyName" class="col-sm-2 control-label">公司名称 </label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="new_companyName" placeholder="公司名称"
                                   name="com_name"/>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" id="new_comMoney" name="com_money">
                                ...
                                <c:forEach items="${moneyType}" var="item">
                                    <option value="${item.dict_id}"
                                            <c:if test="${item.dict_id == comMoney}"> selected</c:if>>${item.dict_item_name }</option>
                                </c:forEach>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="new_principal" placeholder="负责人"
                                   name="com_principal"/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="new_education" placeholder="学历要求"
                                   name="com_education"/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="new_address" placeholder="公司地址"
                                   name="com_address"/>
                        </div>
                    </div>
                </form>
            ...
            <div class="modal-body">
                <form class="form-horizontal" id="edit_company_form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="edit_companyName" placeholder="公司名称"
                                   name="com_name"/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" id="edit_companyFrom" name="com_source">
                                ...
                                <c:forEach items="${fromType}" var="item">
                                    <option value="${item.dict_id}"
                                            <c:if test="${item.dict_id == comSource}"> selected</c:if>>${item.dict_item_name }
                                    </option>
                                </c:forEach>
                            </select>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" id="edit_comIndustry" name="com_industry">
                                ...
                                <c:forEach items="${industryType}" var="item">
                                    <option value="${item.dict_id}"
                                            <c:if test="${item.dict_id == comIndustry}"> selected</c:if>>${item.dict_item_name }</option>
                                </c:forEach>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" id="edit_comPeople" name="com_people">
                                ...
                                <c:forEach items="${peopleType}" var="item">
                                    <option value="${item.dict_id}"
                                            <c:if test="${item.dict_id == comPeople}"> selected</c:if>>${item.dict_item_name }</option>
                                </c:forEach>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="edit_principal" placeholder="负责人"
                                   name="com_principal"/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="edit_education" placeholder="学历要求"
                                   name="com_education"/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="edit_address" placeholder="公司地址"
                                   name="com_address"/>
                        </div>
                    </div>
                </form>
...
<!--简历信息模态框-->
<div class="modal fade" id="cvDialog" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                ...
                <h4 class="modal-title">简历信息</h4>
            </div>
            <div class="modal-body" id="cvInformation">
                <div class="form-group">
                    <div class="col-sm-10">
                        <v-for></v-for>
                    </div>
...
<!-- Axios -->
<script src="<%=basePath%>js/axios.js"></script>
...
<script type="text/javascript">
    ...
    var app = new Vue({
        ...
        methods: {
            showAllCV: function (com_id) {
                var that = this;
                axios.get("<%=basePath%>CV/showAllCV.action?com_id=" + com_id).then(
                    function (response) {
...
/*                        that.cv = data;*/
    ...
    /*    function showAllCV(com_id) {
            $.ajax({
                url: "<%=basePath%>CV/showAllCV.action",
            type: "get",
            data: {"com_id": com_id},
            success: function (data) {
                $("#cv").val("");
