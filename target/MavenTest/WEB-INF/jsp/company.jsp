                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#" class="btn btn-primary btn-xs" data-toggle="modal"
                                       data-target="#customerEditDialog" onclick="editCompany(${row.com_id})">修改</a>
                                    <a href="#" class="btn btn-danger btn-xs"
                                       onclick="deleteCompany(${row.com_id})">删除</a>
                                </td>
                            </tr>
                        </c:forEach>
                        </tbody>
                            ...
                            <select class="form-control" id="new_comIndustry" name="com_industry">
                                ...
                                <c:forEach items="${industryType}" var="item">
                                    <option value="${item.dict_id}"<c:if
                                            test="${item.dict_id == comIndustry}"> selected</c:if>>
                                            ${item.dict_item_name }
                                    </option>
                                </c:forEach>
                            </select>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" id="new_comPeople" name="com_people">
                                ...
                                <c:forEach items="${peopleType}" var="item">
                                    <option value="${item.dict_id}"<c:if
                                            test="${item.dict_id == comPeople}"> selected</c:if>>
                                            ${item.dict_item_name }
                                    </option>
                                </c:forEach>
                            </select>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" id="new_comMoney" name="com_money">
                                ...
                                <c:forEach items="${moneyType}" var="item">
                                    <option value="${item.dict_id}"<c:if
                                            test="${item.dict_id == comMoney}"> selected</c:if>>${item.dict_item_name }</option>
                                </c:forEach>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" id="edit_companyFrom" name="com_source">
                                ...
                                <c:forEach items="${fromType}" var="item">
                                    <option value="${item.dict_id}"<c:if
                                            test="${item.dict_id == comSource}"> selected</c:if>>${item.dict_item_name }</option>
                                </c:forEach>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" id="edit_comIndustry" name="com_industry">
                                ...
                                <c:forEach items="${industryType}" var="item">
                                    <option value="${item.dict_id}"<c:if
                                            test="${item.dict_id == comIndustry}"> selected</c:if>>${item.dict_item_name }</option>
                                </c:forEach>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" id="edit_comPeople" name="com_people">
                                ...
                                <c:forEach items="${peopleType}" var="item">
                                    <option value="${item.dict_id}"<c:if
                                            test="${item.dict_id == comPeople}"> selected</c:if>>${item.dict_item_name }</option>
                                </c:forEach>
                            </select>
                        </div>
                    </div>
