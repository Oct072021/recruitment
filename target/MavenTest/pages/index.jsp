            ...
            <el-main>
                ...
                <el-row>
                    ...
                    <el-dialog title="新建招聘信息" :visible.sync="newDialog" top="7vh" width="40%">
                        <el-form id="newCom" :model="newCom" ref="newCompany" :rules="newComRules">
                        ...
                        <div slot="footer" class="dialog-footer">
                            ...
                            <el-button type="primary" @click="newCompany(newCom)">确 定</el-button>
                        </div>
                    </el-dialog>
                </el-row>
                <el-row>
                        ...
                        <el-table-column>
                            <template slot-scope="scope">
                                <el-button type="primary" icon="el-icon-eleme" size="small"
                                           @click="editCompany(scope.row.id)">修改
                                </el-button>
    ...
    new Vue({
        ...
        methods: {
            newCompany: function () {
                ...
                axios.post("<%=basePath%>company/create.action", that.nerCom)
